    ...
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-4xl mx-auto">
        ...
        <c:if test="${empty movie or empty showTime}">
            <div class="text-center">
                <h2 class="text-xl font-bold text-red-500">Error: Movie or Show Time is unavailable.</h2>
                <a href="${pageContext.request.contextPath}/" class="mt-4 inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Return to Home</a>
            </div>
        </c:if>
        ...
        <c:if test="${not empty movie and not empty showTime and not empty showDate}">
            <div class="flex flex-col md:flex-row">
                ...
                <div class="mt-4 md:mt-0 md:ml-6">
                    ...
                    <p class="mt-1"><strong>Show Time:</strong> ${showTime.showTime} on ${showDate.showDate}</p>
                    <p class="mt-1"><strong>Ticket Price:</strong> $${movie.ticketPrice}</p>
                    ...
                    <form action="${pageContext.request.contextPath}/booking?action=create" method="post" class="mt-6">
                        ...
                        <!-- Number of Seats -->
                        <div class="mb-4">
                            <label for="numberOfSeats" class="block text-gray-700 font-bold mb-2">Number of Seats:</label>
                            <input type="number" id="numberOfSeats" name="numberOfSeats" value="1" min="1" max="10"
                        ...
                        <!-- Display Total Price -->
                        <div class="mb-4">
                            <label for="totalPrice" class="block text-gray-700 font-bold mb-2">Total Price:</label>
